...
```tip
Just selecting a new image does not save your change. You still have to select one of the 'save' buttons at the bottom of the page. This will make the new image show up in your preview site.
```
